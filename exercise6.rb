...
TIP: Don't start your variable names with capital letters, otherwise Ruby will think you want to make a constant 
instead of a variable. Making a constant is a way of giving a name to a value that won't ever be reassigned.
=end

def temperature_converter(temperature)
    puts "Enter a temperature in Fahrenheit"
    temperature_in_Fahrenheit = gets.chomp.to_i
    temperature_in_Celsius = (temperature_in_Fahrenheit - 32) * 5 / 9
    return "The temperature in Celsius is #{temperature_in_Celsius}"
end
